...
public interface UserMapper {
    ...
    int updateByExampleSelective(@Param("record") User record, @Param("fnic") UserExample example);

    @UpdateProvider(type=UserSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") User record, @Param("fnic") UserExample example);
