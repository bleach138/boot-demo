...
function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
   ...
   * were made, but it is also possible to skip one or more requests (for fnic to have them
   ...
   * @param {number=} [skip=0] - Number of pending requests to skip. For fnic, a value of `5`
