...
/**
 * Created by hjhuang on 2018/6/26.
 */
public class TestCRC {
    ...
    public static int getCRC1021(byte b[], int len) {
        //char crc = 0;
        int crc = 0xffff;
        byte hb = 0;
        int j = 0;
...
//        bBuf.put(transToByte( 0x02));

//        bBuf.put(transToByte( 0x0d));
//        bBuf.put(transToByte( 0x01));
//        bBuf.put(transToByte( 0x03));
//        bBuf.put(transToByte( 0x53));
//        bBuf.put(transToByte( 0x41));
//        bBuf.put(transToByte( 0x35));
//        bBuf.put(transToByte( 0x32));
//        bBuf.put(transToByte( 0x15));
//        bBuf.put(transToByte( 0x03));
//        bBuf.put(transToByte( 0x62));
//        bBuf.put(transToByte( 0x00));
//        bBuf.put(transToByte( 0x02));
        ...
        //System.out.println(getCrc(bBuf.array()));
//        System.out.println(getCRC1021(bBuf.array(),4));
        set(bBuf.array());

        short x = get();
        System.out.println(Integer.toHexString(x));
        System.out.println((byte) ((x >> 8) & 0xff)) ;
        System.out.println((byte) (x & 0xff));
    }
